...
const IconButton = forwardRef(({ variant = 'text', shape = 'square', children, color = 'primary', ...others }: {
    variant: string;
    shape: string;
    children: React.ReactNode;
    color: "secondary" | "error" | "warning" | "info" | "success" | "primary" | "inherit" | "default";
}) => {
    const theme = useTheme();

    return (
        <IconButtonStyle disableRipple variant={variant} shape={shape} theme={theme} color={color} {...others}>
            {children}
        </IconButtonStyle>
    );
});
