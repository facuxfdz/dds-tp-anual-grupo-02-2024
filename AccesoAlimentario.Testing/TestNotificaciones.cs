...
{   
    ...
    public void Setup()
    {
        ...
        _persona = new PersonaHumana("Nico", "Perez", _medioContacto, _direccion, _documentoIdentidad, SexoDocumento.Masculino);
    ...
    public void Notificacion_CrearNotificacionAlerta_True()
    {
        ...
        Assert.That(notificacionCreada.Mensaje, Is.EqualTo("Un sensor ha detectado una alerta de tipo Conexion. Por favor, acudir al lugar en la brevedad."));
    }
    ...
    public void Notificacion_CrearNotificacionFallaTecnica_True()
    {
        ...
        Assert.That(notificacionCreada.Asunto, Is.EqualTo("Acceso Alimentario: Un usuario ha reportado una Falla Técnica"));
        Assert.IsTrue(notificacionCreada.Mensaje.Contains("Un usuario ha reportado una falla tecnica en una heladera. Por favor, acudir al lugar en la brevedad."));
    ...
    public void Notificacion_CrearNotificacionExcedente()
    {
       ...
       Assert.IsTrue(notificacionCreada.Mensaje.Contains("Faltan 9 viandas para que se llene la heladera. Por favor, distribuir en la brevedad."));
    ...
    public void Notificacion_CrearNotificacionFaltante()
    {
        ...
        Assert.IsTrue(notificacionCreada.Mensaje.Contains("Faltan 1 viandas para vaciar la heladera. Por favor, reponer en la brevedad."));
    }
    ...
    public void Notificacion_CrearNotificacionUsuarioCreado()
    {
        ...
        Assert.IsTrue(notificacionCreada.Mensaje.Contains("Su usuario <b>Nico</b> se ha creado con exito, su contraseña es: <b>1234</b>.<br>No comparta esta información, muchas gracias."));
    }
